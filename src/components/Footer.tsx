    ...
    <footer className="bg-gray-900 text-gray-300 pt-16 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-white">DreamMattress</span>
            </div>
            <p className="text-sm mb-4">
              Crafting premium mattresses for your perfect sleep experience since 2010.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex items-center gap-2 text-sm">
                ...
                <span>info@dreammattress.com</span>
              </div>
              <div className="flex items-center gap-2 text-sm">
        ...
        <div className="border-t border-gray-800 pt-8 text-center text-sm">
          <p>&copy; {new Date().getFullYear()} DreamMattress. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
